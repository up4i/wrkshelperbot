...
# Stubs — filled in Task 7 and 8
async def cmd_ban(update, ctx): pass
async def cmd_dban(update, ctx): pass
async def cmd_unban(update, ctx): pass
async def cmd_kick(update, ctx): pass
async def cmd_dkick(update, ctx): pass
